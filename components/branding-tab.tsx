...
export function BrandingTab({ name, startupIdea, demo }: BrandingTabProps) {
	...
	useEffect(() => {
		(async () => {
			...
			let res = await fetch('https://hackknight-api-4b72e0673517.herokuapp.com//branding/images', {
				method: 'POST',
				headers: {
			...
			res = await fetch('https://hackknight-api-4b72e0673517.herokuapp.com//branding/text', {
				method: 'POST',
				headers: {
					'Content-Type': 'application/json',
				},
